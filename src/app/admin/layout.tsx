      ...
      <aside className="w-64 bg-gray-900/80 border-r border-gray-800 flex flex-col flex-shrink-0">
        ...
        <div className="p-6 border-b border-gray-800">
          <Link href="/admin" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">InternetProviders.ai</p>
            </div>
          </Link>
        </div>
        ...
        <div className="p-4 border-t border-gray-800 space-y-1">
          ...
          <button
            ...
            disabled={loggingOut}
            className="w-full flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-red-400 rounded-lg hover:bg-red-500/10 transition-colors disabled:opacity-50"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
