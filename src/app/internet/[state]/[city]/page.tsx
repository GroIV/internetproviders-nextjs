...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const content = await getContentByPath(`/internet/${state}/${citySlug}`)
  if (content) {
...
export default async function CityPage({ params }: Props) {
  ...
  const content = await getContentByPath(`/internet/${state}/${citySlugParam}`)
  if (content) {
    ...
    const breadcrumbSchema = {
      ...
      itemListElement: [
        ...
        },
        {
          ...
          item: 'https://www.internetproviders.ai/internet',
        },
        {
          '@type': 'ListItem',
          position: 3,
          name: stateName,
          item: `https://www.internetproviders.ai/internet/${state}`,
        },
        {
          '@type': 'ListItem',
          position: 4,
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-4xl mx-auto">
              ...
              <nav className="ipai-breadcrumb" aria-label="Breadcrumb">
                ...
                <Link href="/internet">Internet by State</Link>
                <span className="ipai-breadcrumb__separator">/</span>
                <Link href={`/internet/${state}`}>{stateName}</Link>
                <span className="ipai-breadcrumb__separator">/</span>
