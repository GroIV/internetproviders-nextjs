    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">Internet Tools</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {tools.map((tool) => (
            <Link
              key={tool.id}
              href={tool.href}
              className="group bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all hover:scale-[1.02]"
            >
        ...
        <div className="mt-12 bg-gray-900 border border-gray-800 rounded-xl p-8">
          <h2 className="text-2xl font-bold mb-4 text-center">Why Use Our Tools?</h2>
          <div className="grid md:grid-cols-3 gap-6 text-center">
            ...
            <div>
              <div className="text-3xl mb-2">No Sign-up</div>
              <div className="text-gray-400">Required</div>
            </div>
            <div>
              <div className="text-3xl mb-2">Instant</div>
