...
const availableLogos: Record<string, { file: string; needsLightBg?: boolean }> = {
  '4change-energy': { file: '4change-energy.svg' },
  'adt': { file: 'adt.svg' },
  ...
  'rise-broadband': { file: 'rise-broadband.svg' },
  'spectrum': { file: 'spectrum.png', needsLightBg: true },
  'starlink': { file: 'starlink.png' },
  't-mobile': { file: 't-mobile.png' },
  'tds-telecom': { file: 'tds-telecom.png', needsLightBg: true },
  'verizon-5g': { file: 'verizon-5g.png', needsLightBg: true },
  'verizon-fios': { file: 'verizon-fios.jpg', needsLightBg: true },
  'viasat': { file: 'viasat.png' },
  'vivint': { file: 'vivint.png', needsLightBg: true },
...
export const providerColors: Record<string, { bg: string; text: string }> = {
  '4change-energy': { bg: 'bg-green-600', text: 'text-white' },
  'adt': { bg: 'bg-blue-600', text: 'text-white' },
  ...
  'bellhop-moving': { bg: 'bg-orange-500', text: 'text-white' },
  ...
  'chariot-energy': { bg: 'bg-teal-600', text: 'text-white' },
  ...
  'rise-broadband': { bg: 'bg-green-600', text: 'text-white' },
  ...
  'verizon-5g': { bg: 'bg-red-600', text: 'text-white' },
  'verizon-fios': { bg: 'bg-red-600', text: 'text-white' },
  'viasat': { bg: 'bg-blue-600', text: 'text-white' },
  'vivint': { bg: 'bg-orange-500', text: 'text-white' },
