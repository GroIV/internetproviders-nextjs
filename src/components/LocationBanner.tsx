...
export function LocationBanner() {
  ...
  if (!location?.zipCode && !showEdit) {
    return (
      <div className="bg-blue-900/30 border-b border-blue-800/50 py-2">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center gap-3 text-sm">
            <span className="text-gray-300">Enter your ZIP to see local providers</span>
            <button
            ...
            <button
              ...
              className="px-3 py-1 border border-gray-600 text-gray-300 rounded text-xs font-medium hover:border-gray-500 flex items-center gap-1"
            >
