...
export function FloatingChatButton() {
  ...
  return (
    <>
      ...
      >
        {isOpen ? (
          <svg className="w-6 h-6 mx-auto text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="relative">
            ...
            {messages.length > 1 && (
              <span className="absolute -top-0.5 -right-0.5 w-3 h-3 bg-blue-500 rounded-full" aria-label={`${messages.length} messages`} />
            )}
          </div>
        )}
      </button>
